...
class PopoverPageController {
    ...
    @GetMapping
    fun render() = view(PopoverPage(), ::UiKitLayout)
}
...
fun Component.DistanceAndSkidding() {
    ...
    div {
        Button { id = "btn-distance"; +"Distance 16" }
    ...
    br
    div {
        Button { id = "btn-skidding"; +"Skidding 24" }
    ...
    br
    div {
        Button { id = "btn-both"; +"Distance 12, Skidding 12" }
...
fun Component.WithoutArrow() {
    h2 { +"Without Arrow" }
    div {
        Button { id = "btn-no-arrow"; +"No Arrow" }
