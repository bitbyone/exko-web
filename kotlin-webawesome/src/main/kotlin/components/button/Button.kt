...
class WA_BUTTON(consumer: TagConsumer<*>) : HTMLTag(
    "wa-button",
    consumer.orNewIfNotAlready(::WebComponentsTagConsumer),
    emptyMap(),
    inlineTag = false,
    emptyTag = false
), ButtonServerCommonFlowInteractivePhrasingGroupFacadeAttributeContent, WebComponent, CoreAttributeGroupFacade,
    VariantAware, AppearanceAware, SizeAware, DisabledAware, LoadingAware,
    ButtonTypeAware, HrefAware, TargetAware, RelAware, DownloadAware,
    NameAware, TitleAware, ValueAware, WithCaretAware, PillAware,
    FormAware, FormActionAware, FormEnctypeAware, FormMethodAware, FormNoValidateAware, FormTargetAware {
